...
input_file_discharge = "data/discharge/{}/{}/{}-{}.csv".format(basin, river_station, start_year, end_year)
...
df['Discharge'] = df['Discharge'].rolling(48,center=True).mean()
...
axs[0].set_ylabel('discharme m^3/s', color=color)
